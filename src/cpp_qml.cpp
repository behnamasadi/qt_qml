...
subclass of QQuickWindow which will automatically load and display a QML scene
*/
...
//https://youtu.be/quFciLDIxUw?list=PL6CJYn40gN6hdNC1IGQZfVI707dh9DPRc&t=775
    ...
    context->setContextProperty("_aString",QString("AAAA"));// the under line is just a convention to emphasis it is coming from cpp in the qml file
